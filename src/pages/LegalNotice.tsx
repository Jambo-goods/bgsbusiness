...
export default function LegalNotice() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Mentions Légales | BGS Invest</title>
      </Helmet>
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none text-bgs-blue/80">
          ...
          <p>
            <strong>Raison sociale :</strong> BGS Invest SAS<br />
            ...
            <strong>Email :</strong> contact@bgsinvest.com
          </p>
          
          <h2 className="text-2xl font-semibold mt-8 mb-4">2. Directeur de la publication</h2>
          <p>
            M. Jean Dupont, en qualité de Président de BGS Invest SAS.
          </p>
          ...
          <p>
            L'ensemble du contenu du site BGS Invest, incluant, de façon non exhaustive, les graphismes, images, textes, vidéos, animations, sons, logos, gifs et icônes ainsi que leur mise en forme sont la propriété exclusive de BGS Invest SAS à l'exception des marques, logos ou contenus appartenant à d'autres sociétés partenaires ou auteurs.
          </p>
          <p>
            Toute reproduction, distribution, modification, adaptation, retransmission ou publication, même partielle, de ces différents éléments est strictement interdite sans l'accord exprès par écrit de BGS Invest SAS. Cette représentation ou reproduction, par quelque procédé que ce soit, constitue une contrefaçon sanctionnée par les articles L.335-2 et suivants du Code de la propriété intellectuelle.
          </p>
          
          <h2 className="text-2xl font-semibold mt-8 mb-4">5. Crédits photographiques</h2>
          <p>
            Les photographies et visuels utilisés sur le site BGS Invest sont issus de banques d'images libres de droits, de photographes professionnels avec lesquels BGS Invest SAS a conclu un contrat, ou des visuels propriétaires de BGS Invest SAS.
          </p>
          
          <h2 className="text-2xl font-semibold mt-8 mb-4">6. Liens hypertextes</h2>
          <p>
            Le site BGS Invest peut contenir des liens hypertextes vers d'autres sites internet. BGS Invest SAS ne peut être tenu responsable du contenu de ces sites et de l'usage qui pourrait en être fait par les utilisateurs.
          </p>
          ...
          <p>
            Conformément aux dispositions du Code de la consommation concernant le règlement amiable des litiges, BGS Invest SAS adhère au Service du Médiateur de la consommation. Vous pouvez recourir gratuitement à ce service de médiation pour les litiges de consommation liés à l'utilisation de notre plateforme.
          </p>
          <p>
