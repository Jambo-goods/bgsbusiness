...
export default function ProjectCard({
  ...
  return <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden animate-fade-up border border-gray-50" style={{
    animationDelay: `${index * 0.1}s`
  }}>
      <div className="relative overflow-hidden group">
        <img src={project.image} alt={project.name} className="w-full h-48 object-cover transition-transform duration-700 group-hover:scale-105" />
      ...
      <div className="p-6">
        ...
        <Link to={`/project/${project.id}`} className="flex items-center justify-center w-full bg-bgs-blue text-white py-3 rounded-lg hover:bg-bgs-blue-light transition-colors font-medium">
          Voir le projet
